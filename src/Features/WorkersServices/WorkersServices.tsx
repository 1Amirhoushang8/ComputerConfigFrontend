...
const WorkersServices = () => {
    ...
    // ---------- Data loader (server‑side pagination) ----------
    ...
    return (
        <div className="container-fluid">
            ...
            <DataTable
                data={workers}                      // directly from API, no client filter/sort
                columns={columns}
                keyExtractor={(w) => w.id}
                actions={actions}
                userRole={user?.role}
                    ...
                    <div className="modal-content" dir="rtl">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value={editForm.phoneNumber}
                                       onChange={(e) => setEditForm({ ...editForm, phoneNumber: e.target.value })} dir="ltr" required />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">ایمیل</label>
                                <input type="email" className="form-control" value={editForm.email}
                                       onChange={(e) => setEditForm({ ...editForm, email: e.target.value })} dir="ltr" placeholder="اختیاری" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">کد ملی</label>
                                <input type="text" className="form-control" value={editForm.personalId}
                                       onChange={(e) => setEditForm({ ...editForm, personalId: e.target.value })} />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">تخصص</label>
                                <input type="text" className="form-control" value={editForm.specialty}
                                       onChange={(e) => setEditForm({ ...editForm, specialty: e.target.value })} placeholder="مانند: سخت‌افزار، نرم‌افزار" />
                            </div>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={closeEditModal} disabled={savingEdit}>انصراف</button>
                ...
                <div className="modal-dialog">
                    <div className="modal-content" dir="rtl">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                <label className="form-label">نام کامل *</label>
                                <input type="text" className={`form-control ${addFieldErrors.fullName ? 'is-invalid' : ''}`}
                            ...
                            <div className="mb-3">
                                <label className="form-label">شماره موبایل *</label>
                                <input type="text" className={`form-control ${addFieldErrors.phoneNumber ? 'is-invalid' : ''}`}
                            ...
                            <div className="mb-3">
                                <label className="form-label">ایمیل</label>
                                <input type="email" className={`form-control ${addFieldErrors.email ? 'is-invalid' : ''}`}
                                       value={addForm.email}
                                       onChange={(e) => {
                                           setAddForm({ ...addForm, email: e.target.value });
                                           if (addFieldErrors.email) setAddFieldErrors(prev => ({ ...prev, email: undefined }));
                                       }} dir="ltr" placeholder="اختیاری" />
                                {addFieldErrors.email && <div className="invalid-feedback">{addFieldErrors.email}</div>}
                            </div>
                            {/* Personal ID */}
                            <div className="mb-3">
                                <label className="form-label">کد ملی *</label>
                                <input type="text" className={`form-control ${addFieldErrors.personalId ? 'is-invalid' : ''}`}
                            ...
                            <div className="mb-3">
                                <label className="form-label">تخصص *</label>
                                <input type="text" className={`form-control ${addFieldErrors.specialty ? 'is-invalid' : ''}`}
                                       ...
                                       }} placeholder="مانند: سخت‌افزار، نرم‌افزار" required />
                                {addFieldErrors.specialty && <div className="invalid-feedback">{addFieldErrors.specialty}</div>}
                            </div>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={closeAddModal} disabled={savingAdd}>انصراف</button>
            ...
            <ConfirmModal
                ...
                title="حذف تعمیرکار"
                message={<span>آیا از حذف تعمیرکار <strong> {workerToDelete?.fullName} </strong> مطمئن هستید؟ این عمل قابل بازگشت نیست.</span>}
                confirmLabel="حذف"
                cancelLabel="انصراف"
